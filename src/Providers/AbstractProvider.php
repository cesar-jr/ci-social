...
abstract class AbstractProvider
{
    ...
    public function redirect()
    {
        ...
        if ($this->usesState() || $this->usesPKCE()) {
            ...
            if ($this->usesPKCE()) {
                $session->set('code_verifier', $this->getCodeVerifier());
            }
        }
    ...
    public function user()
    {
        ...
        $user = $this->getUserByToken($response['access_token'] ?? null);
